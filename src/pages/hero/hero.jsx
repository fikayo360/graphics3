    ...
    return (
        <section id="hero" ref={container}>
           { navActive? (<div id='navMobile' onClick={toggleMobileNav} ref={ref} >
            ...
            <div id='heroOther'>
                <p><span id='txtG'>Electron weddings.</span><span className='hIc'><img src='profile.png' /></span> we provide exceptional wedding photography services. We based in lagos state nigeria...
                </p>
