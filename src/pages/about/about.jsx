    ...
    return (
        <section id='about'>
            <TypeAnimation
                    ...
                    />
            <p>
            With a keen eye for detail and an unwavering commitment to excellence, I specialize in capturing the magic of your events – from the quiet anticipation
            ...
            and to tell stories that will be cherished for generations to come. Whether it's a stolen glance, a tender embrace, or a heartfelt laugh,
             ...
             So, if you're looking for more than just a photographer – if you're searching for a partner who will capture the essence of your love story with creativity,
              passion, and unparalleled dedication – then look no further than blizzid's Photography. Let's embark on this journey together, and let's create memories that will 
              last a lifetime.
              </p>
        </section>
    ) 
